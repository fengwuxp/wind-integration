...
public interface BasedOnFreezeFundsAccountTransactionService extends FundsAccountTransactionService {
     ...
     * 支出 {@param request#getAmount()} 额度不能大于已冻结额度{@link FundsAccount#getFreezeAmount()} ()}
     *
     ...
     */
    @NonNull
    String freeze(@NonNull FundsAccountId id, @NonNull FundsAccountTransactionRequest request);
     ...
     */
    @NonNull
    String unfreeze(@NonNull FundsAccountId id, @NonNull FundsAccountTransactionRequest request);
     ...
     */
    @NonNull
    String freezeAndDebit(@NonNull FundsAccountId id, @NonNull FundsAccountTransactionRequest request);
