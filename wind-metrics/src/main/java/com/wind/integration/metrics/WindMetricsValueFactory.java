...
public interface WindMetricsValueFactory {
     ...
     */
    @NotNull
    <N extends Number> WindMetricsValue<N> value(@NotBlank String name, @Nullable MetricQuery query);
     ...
     */
    @NotNull
    <V> WindStructuredMetricsValue<V> fieldValues(@NotBlank String name, @Nullable MetricQuery query);
}
