 ...
 **/
public interface WindBucketTemplate {
     ...
     */
    WindOssFile uploadFile(@NotBlank String objectKey, @NotNull InputStream inputStream, Map<String, String> metadata) throws OSSException;
     ...
     */
    InputStream downloadFile(String objectKey) throws OSSException;
     ...
     */
    void deleteFile(String objectKey) throws OSSException;
     ...
     */
    List<String> listFiles(String keyPrefix, int maxKeys) throws OSSException;
     ...
     */
    void copyFile(String objectKey, String destBucketName) throws OSSException;
     ...
     */
    void copyFile(String sourceKey, String destBucketName, String destKey) throws OSSException;
     ...
     */
    <T> T getFileMetadata(String objectKey) throws OSSException;
}
